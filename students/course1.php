...
$course_name_fetch = mysqli_query($conn,"SELECT `sub_name` FROM `course_name` where `sub_code`='$courses_array[2]' ");
                      $course_name_fetched=mysqli_fetch_assoc($course_name_fetch);
                      $course_name_val=$course_name_fetched['sub_name'];

$teachers_fetch=mysqli_query($conn,"SELECT * from `teachers` where `co1`='$courses_array[2]' or `co2`='$courses_array[2]' or `lab`='$courses_array[2]' and `branch`='$branch' ");
            ...
            <div class="row">
              ...
              <div class="col-md-7 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <tH>MARKS</th>
                        <td><?php echo $ia1_fetch['course1'];?></td>
                        <td><?php echo $ia2_fetch['course1'];?></td>
                        <td><?php echo $ia3_fetch['course1'];?></td>
                        <td><?php echo best_avg($ia1_fetch['course1'],$ia2_fetch['course1'],$ia3_fetch['course1']);?></td>
                       </tr>
                 ...
                 <form action="message_get.php" method="post" enctype="multipart/form-data"  class="form-horizontal form-label-left" id="demo-form" data-parsley-validate>'
                   ...
                   <?php echo '<input type="hidden" name="teacher_id" value="'.$id_teacher.'">';?>
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12  col-xs-12 col-md-offset-1">
                          ...
                          <button type="submit" name="message_submit" class="btn btn-success">Upload</button>
                        </div>
                      </div>
