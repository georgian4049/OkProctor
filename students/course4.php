...
$course_name_fetch = mysqli_query($conn,"SELECT `sub_name` FROM `course_name` where `sub_code`='$courses_array[5]' ");
                      $course_name_fetched=mysqli_fetch_assoc($course_name_fetch);
                      $course_name_val=$course_name_fetched['sub_name'];

$teachers_fetch=mysqli_query($conn,"SELECT * from `teachers` where `co1`='$courses_array[5]' or `co2`='$courses_array[5]' or `lab`='$courses_array[5]' and `branch`='$branch'");
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <tH>MARKS</th>
                        <td><?php echo $ia1_fetch['course4'];?></td>
                        <td><?php echo $ia2_fetch['course4'];?></td>
                        <td><?php echo $ia3_fetch['course4'];?></td>
                        <td><?php echo best_avg($ia1_fetch['course4'],$ia2_fetch['course4'],$ia3_fetch['course4']);?></td>
                       </tr>
