      ...
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
          ...
          <!--        <li><a  href="home.php"><i class="fa fa-home"></i> Home</a></li>
                  ...
                  <li><a><i class="fas fa-user-cog"></i> Manage User<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="add_user.php"><i class="fa fa-user-plus"></i>Add User</a></li>
                      <li><a href="delete_user.php"><i class="fa fa-user-times"></i>Delete User</a></li>
                  <!--    <li><a href="update_user.php"><i class="fas fa-user-edit"></i> Update User</a></li> -->
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="include/logout.php"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
